...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ProblemDetail> handleUserNotFound(UserNotFoundException ex, WebRequest request) {
    log.warn("User not found: id = {}, message: {}", extractId(ex.getMessage()), ex.getMessage(), ex);
  ...
  public ResponseEntity<ProblemDetail> handleCardNotFound(CardNotFoundException ex, WebRequest request) {
    log.warn("Card Not Found: id = {}, message: {}", extractId(ex.getMessage()), ex.getMessage(), ex);
  ...
  public ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, WebRequest request) {
    ...
    ProblemDetail problem = createProblemDetail(HttpStatus.BAD_REQUEST, "Validation Failed",
            "One or more parameters haven't passed validation", request);
  ...
  public ResponseEntity<ProblemDetail> handleAllExceptions(Exception ex, WebRequest request) {
    ...
    ProblemDetail problem = createProblemDetail(HttpStatus.INTERNAL_SERVER_ERROR, "Internal Server Error",
